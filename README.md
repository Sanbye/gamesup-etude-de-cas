...
- `GameController` (JDBC brut, identifiants MySQL en dur) a été supprimé : il sera remplacé par une architecture en couches (repository / service / contrôleur + DTOs) dans la suite de cette étape.

### Reste à faire pour cette étape

- Repositories Spring Data JPA
- Services métier (logique applicative, respect SOLID)
- Contrôleurs REST + DTOs
- Fonction de recherche de jeux
